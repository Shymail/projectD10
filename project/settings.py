...
SECRET_KEY = 'django-insecure-u$n7kpbj@rd@6sti8s(lsrq(2-tr8f_2j5)i+i^bz@u#mlw4%9'
...
EMAIL_HOST_USER = 'filip-andr'  # ваше имя пользователя, например, если ваша почта user@yandex.ru, то сюда надо
...
DEFAULT_FROM_EMAIL = 'filip-andr@yandex.ru'
